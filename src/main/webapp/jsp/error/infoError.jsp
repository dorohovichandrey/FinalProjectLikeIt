...
<fmt:bundle basename="text">
    ...
    <c:set var="page"  value="page.infoError" scope="session" />
            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">Ошибка ${pageContext.errorData.statusCode}</h3>
                    </div>
                    <div class="panel-body">
                        Извините за неудобства. Попробуйте воспользоваться сервисом позже.
                    </div>
                </div>
